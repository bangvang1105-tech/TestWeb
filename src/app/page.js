...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 px-4 py-12">
      ...
      {/* Thanh thông báo */}
      <div className="mb-4 w-full max-w-md p-3 text-center text-sm font-medium rounded-xl border shadow-sm bg-green-50 border-green-200"
        style={{ color: '#4ade80' }}>
      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <a href="#" className="font-medium hover:underline" style={{ color: '#4ade80' }}>
              Quên mật khẩu?
            </a>
          </div>
